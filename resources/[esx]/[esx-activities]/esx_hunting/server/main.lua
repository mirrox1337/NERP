...
AddEventHandler('esx-qalle-hunting:sell', function()
    ...
    if MeatQuantity > 0 or LeatherQuantity > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'Du har sålt ' .. LeatherQuantity + MeatQuantity .. ' och tjänat $' .. LeatherPrice * LeatherQuantity + MeatPrice * MeatQuantity)
    else
