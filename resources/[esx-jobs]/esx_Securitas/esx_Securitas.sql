...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('Securitas',0,'recruit','vakt',50,'{}','{}'),
	('Securitas',1,'officer','Biträdande veteran vakt',60,'{}','{}'),
	('Securitas',2,'sergeant','Assistent',70,'{}','{}'),
	('Securitas',3,'lieutenant','vice chef',80,'{}','{}'),
	('Securitas',4,'boss','chef',90,'{}','{}')
;
