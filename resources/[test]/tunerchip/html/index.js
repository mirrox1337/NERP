...
$(function(){
	...
	$("#boost").slider({min:0.05,value:0.25,step:0.01,max:1.00,change:sliderUpdated});
	...
	$("#brakeforce").slider({min:0.01,value:1.4,max:3,step:0.01,change:sliderUpdated});
	$("#defaultbtn").click(function(){setSliderValues({boost:0.15,fuelmix:1.0,gearchange:9,braking:0.5,drivetrain:0.5,brakeforce:1.2});});	
