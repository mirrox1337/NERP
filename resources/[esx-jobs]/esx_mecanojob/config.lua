...
Config.NPCJobEarnings             = { min = 50, max = 100 }
Config.Locale                     = 'en'

Config.Zones = {
  MecanoActions = {
    Pos   = { x = -353.39, y = -129.87, z = 38.05 },
  ...
  Craft = {
    Pos   = { x = -323.140, y = -129.882, z = 30.999 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 0, g = 255, b = 0 },
    Type  = -1,
  },
  ...
  VehicleSpawnPoint = {
    Pos   = { x = -368.49, y = -108.99, z = 38.68 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Type  = -1,
  },

  VehicleDeleter = {
    Pos   = { x = -355.68, y = -114.91, z = 37.7 },
