...
-- Event when a player start a carthief mission
RegisterServerEvent("esx:startcarthiefmission")
AddEventHandler("esx:startcarthiefmission", function()
 	 local xPlayer = ESX.GetPlayerFromId(source)
 	 sendToDiscord(_U('server_carthief'),xPlayer.name.." ",,_('user_carthief'), Config.red)
