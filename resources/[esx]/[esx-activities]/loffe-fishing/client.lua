...
local Locations = {
    ...
    ["Markers"] = {
       ...
       -- ["SellFish"] = { ["x"] = 387.22, ["y"] = -773.09, ["z"] = 28.29, ["Info"] = "[E] ~g~Sälj Fiskar" },
                        ...
                        if IsControlJustPressed(0, Keys["E"]) then
                            if hasRod and hasBait then
                              ...
                              StartAction(place)
                                ...
                                ESX.ShowNotification("Du har inte vertygen för att börja fiska!")
                            end
                        end
                    end
                end
...
Citizen.CreateThread(function()
    ...
    while true do     
        ...
        if not Fishing then
            ...
            for place, v in pairs(Locations["Markerz"]) do
...
function StartFishing()
    ...
    if hasRod and hasBait then
        Citizen.CreateThread(function()
            ...
            local randomTime = math.random(25000, 40000)
                ...
                if FishOnBait then
                    ...
                    if IsControlPressed(0, Keys['ENTER']) then
                        ...
                        if fishingRod ~= 0 and fishingRod ~= nil then
                            ...
                            TriggerServerEvent('loffe-fishing:removeFishbait')
                            Fishing = false
...
function GetFishingItems()
    ...
    for i=1, #Inventory, 1 do
        ...
        if Inventory[i].name == "fishbait" then
            if Inventory[i].count > 0 then
                hasBait = true
            end
        end
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'fish_menu',
        {
            ...
            elements = {
				...
				{label = 'Fiskebete x 1 [5 SEK]', item = 'fishbait', price = 5, amount = 1},
				{label = 'Fiskebete x 25 [100 SEK]', item = 'fishbait', price = 100, amount = 25},
            }
        },
        function(data, menu)
