Locales['en'] = {
  ...
  ['cloakroom_prompt'] = 'tryck ~INPUT_CONTEXT~ för att öppna omklädningsrummet.',
  ['wear_citizen'] = 'civila kläder',
  ['wear_work'] = 'taxikläder',

  -- garage
  ['spawner_prompt'] = 'tryck ~INPUT_CONTEXT~ för att öppna garaget.',
