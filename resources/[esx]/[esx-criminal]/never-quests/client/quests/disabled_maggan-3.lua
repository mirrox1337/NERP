...
Quest.AddQuest('maggan', 3, function()
	SetNewWaypoint(vehicle.x, vehicle.y)

	Markers.AddMarker('quest_maggan', vehicle, 'Tryck ~INPUT_CONTEXT~ för att starta ett ~b~värdetransportrån', function()
	...
	Markers.AddMarker('quest_maggan_deliver', vehicleDeliverPoint, 'Tryck ~INPUT_CONTEXT~ för att leverara Transporten.', function()
		local ped = GetPlayerPed(-1)
