...
ESX.RegisterServerCallback('cooldowns:getCooldown', function(source, callback, id)
...
ESX.RegisterServerCallback('cooldowns:setCooldown', function(source, callback, id, seconds)
	MySQL.Async.fetchAll('SELECT * FROM cooldowns', {}, function(fetched)
		local found = false
