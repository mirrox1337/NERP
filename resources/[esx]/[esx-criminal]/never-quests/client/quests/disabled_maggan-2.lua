...
Quest.AddQuest('maggan', 2, function()
	SetNewWaypoint(uniforms.x, uniforms.y)

	Markers.AddMarker('quest_maggan', uniforms, 'Tryck ~INPUT_CONTEXT~ för att få uniformerna.', function()
		...
		Markers.AddMarker('quest_maggan_deliver', deliverPoint, 'Tryck ~INPUT_CONTEXT~ för att spara uniformerna.', function()
