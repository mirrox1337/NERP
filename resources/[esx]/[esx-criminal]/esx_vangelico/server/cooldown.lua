...
ESX.RegisterServerCallback('esx_vangelico:getCooldown', function(source, callback, id)
...
ESX.RegisterServerCallback('esx_vangelico:setCooldown', function(source, callback, id, seconds)
	MySQL.Async.fetchAll('SELECT * FROM cooldowns', {}, function(fetched)
		local found = false
