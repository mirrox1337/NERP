...
Strings = {
    ['press_start'] = '~INPUT_PICKUP~ Få bowlingklot',
    ['next_last_select'] = '~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_LEFT~ Byt bana\n~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ Välj\n~INPUT_FRONTEND_RRIGHT~ Avbryt',
    ['bowling_info'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ Rotera\n~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ Ändra kraft\n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ Ändra kameravinekl\n~INPUT_ATTACK~ Kasta\n~INPUT_FRONTEND_RRIGHT~ Avbryt',
    ['force'] = 'Kraft: %s',
    ['strike'] = {'WOHO DU FICK STRIKE!'},
    ['spare'] = {'Bowling', 'Bra spelat, du fick en spare.'},
    ['x_pinsdown'] = {'Bowling', 'Du fick %s av %s käglor'},
    ['this_occupied'] = 'Denna bowlingbana var upptagen.',
    ['every_occupied'] = 'Alla bowlingbanor är upptagna, kom tillbaka senare.',
    ['blip'] = 'Bowling'
}