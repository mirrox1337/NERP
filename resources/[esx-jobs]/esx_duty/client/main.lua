...
AddEventHandler('esx_duty:hasEnteredMarker', function (zone)
  ...
  if zone == 'SecuritasDuty' then
    CurrentAction     = 'Securitas_duty'
    CurrentActionMsg  = _U('duty')
    CurrentActionData = {}
  end
  if zone == 'MekonomenDuty' then
  ...
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0, Keys['E']) then
        ...
        if CurrentAction == 'Securitas_duty' then
          if PlayerData.job.name == 'Securitas' or PlayerData.job.name == 'offSecuritas' then
            TriggerServerEvent('duty:Securitas')
          if PlayerData.job.name == 'Securitas' then
            exports['mythic_notify']:SendAlert('inform', 'ÖÖÖÖÖ')
            Wait(1000)
          else
            exports['mythic_notify']:SendAlert('inform', 'ÖÖÖÖÖ')
            Wait(1000)
          ...
          exports['mythic_notify']:SendAlert('error', _U('notsec'))
          Wait(1000)
          end
        end
        if CurrentAction == 'mecano_duty' then
          ...
          exports['mythic_notify']:SendAlert('error', _U('notmek'))
          Wait(1000)
          end
        end
      end
