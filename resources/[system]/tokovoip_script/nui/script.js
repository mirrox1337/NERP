...
function updateTokovoipInfo(msg) {
	...
	document.getElementById('tokovoipInfo').style.top = '96.3%';
	document.getElementById('tokovoipInfo').style.left = '16%';
	...
	switch (voipStatus) {
		...
		case PLUGIN_INITIALIZING:
			...
			break;
		case WRONG_SERVER:
			msg = `Du är ansluten till fel TeamSpeak Server, Anslut till: <font color="#771282">${voip.plugin_data.TSServer}</font>`;
			screenMessage = 'Fel TeamSpeak Server';
			color = 'red';
			break;
		case WRONG_CHANNEL:
			msg = `Du ansluten till fel TeamSpeak Kanal, Anslut till: <font color="#771282">${voip.plugin_data.TSChannelWait && voip.plugin_data.TSChannelWait !== '' && voip.plugin_data.TSChannelWait || voip.plugin_data.TSChannel}</font>`;
...
function updateConfig(payload) {
	voip = payload;
	document.getElementById('TSServer').innerHTML = `TeamSpeak Server IP: <font color="#771282">${voip.plugin_data.TSServer}</font>`;
	document.getElementById('TSChannel').innerHTML = `TeamSpeak Kanal: <font color="#771282">${(voip.plugin_data.TSChannelWait) ? voip.plugin_data.TSChannelWait : voip.plugin_data.TSChannel}</font>`;
