  ...
  Citizen.CreateThread(function()
    ...
    ESX.TriggerServerCallback('getIdentity', function(identity)
        while true do
            ...
            SetDiscordAppId(608856036333322265)
            SetDiscordRichPresenceAsset('big')
            SetDiscordRichPresenceAssetText ('http:/www.NERP.online')
            SetDiscordRichPresenceAssetSmallText ('http:/www.NERP.online')
            ...
            -- Gammal Rich Presence
            --SetRichPresence(CountPlayers() .. '/64 - ' .. identity.firstname .. ' ' .. identity.lastname)
